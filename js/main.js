...
$(document).ready(function () {
    $('div.appselect').delay(1400).fadeIn(1200).removeClass('hidden');
});


/*$(document).ready(function() { 
    $('#appselectfloat').jqFloat({
        width:0,
        height:20,
        speed:1000,
    });
...
jQuery(document).ready(function(){
        jQuery('#hideshow1').on('click', function(event) {        
            jQuery('#content1').slideToggle(800);
             if($('#hideshow1').val() == '-') {
                jQuery('#hideshow1').val("+");
            } else {
                jQuery('#hideshow1').val("-");
            }
...
jQuery(document).ready(function(){
        jQuery('#hideshow2').on('click', function(event) {        
            jQuery('#content2').slideToggle(800);
             if($('#hideshow2').val() == '+') {
                jQuery('#hideshow2').val("-");
            } else {
                jQuery('#hideshow2').val("+");
            }
...
jQuery(document).ready(function(){
        jQuery('#hideshow3').on('click', function(event) {        
            jQuery('#content3').slideToggle(800);
             if($('#hideshow3').val() == '+') {
                jQuery('#hideshow3').val("-");
            } else {
                jQuery('#hideshow3').val("+");
            }
...
jQuery(document).ready(function($) {
    $(".mainfx").bind("webkitAnimationEnd mozAnimationEnd animationEnd", function(){
    $(this).removeClass("animatedspin")  
    })

    $(".mainfx").hover(function(){
    $(this).addClass("animatedspin");        
    })
});